...
public class SettingsController implements MouseListener {
    ...
    public SettingsController(SystemView views) { //Constructor q recibe como parametro views de clase objeto SystemView
        this.views = views;
        //Vamos a poner los panels y labels en escucha los colocamos en el constructor
    ...
    public void mouseEntered(MouseEvent e) {
        if (e.getSource() == views.jLabelProducts) {
            views.jPanelProducts.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelPurchases) {
            views.jPanelPurchases.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelCustomers) {
            views.jPanelCustomers.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelEmployees) {
            views.jPanelEmployees.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelSuppliers) {
            views.jPanelSuppliers.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelCategories) {
            views.jPanelCategories.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelReports) {
            views.jPanelReports.setBackground(new Color(0,153,153));
        } else if (e.getSource() == views.jLabelSettings) {
            views.jPanelSettings.setBackground(new Color(0,153,153));
        }
    }
